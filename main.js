...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/DaIGMe1FA/model.json',modelLoaded);
...
function gotResults(error, results){
    if(error){
        ...
        if(results[0].label == "K-Pop"){
            document.getElementById("result_emoji").innerHTML = "&#129310;";
            document.getElementById("quote").innerHTML = "K-Pop Army";
        }
